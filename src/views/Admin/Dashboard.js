...
import PositiveState from "components/PositiveState/PositiveState";
  ...
  return (
    <>
      <Container fluid>
        ...
        <Row>
          <Col lg="3" sm="6" xs="12"><Link to="/admin/users?filter=Students" style={{ textDecoration: 'none' }}>
          ...
          <Col lg="3" sm="6" xs="12"><Link to="/admin/users?filter=Teachers" style={{ textDecoration: 'none' }}><Card className="card-stats"><Card.Body><Row><Col xs="5"><div className="icon-big text-center"><i className="nc-icon nc-badge text-success"></i></div></Col><Col xs="7"><div className="numbers"><p className="card-category">إجمالي المدرسين</p><Card.Title as="h4">{loadingStats ? <Spinner size="sm" /> : stats.teachers}</Card.Title></div></Col></Row></Card.Body><Card.Footer><hr /><div className="stats"><i className="fas fa-redo mr-1"></i>عرض التفاصيل</div></Card.Footer></Card></Link></Col>
          <Col lg="3" sm="6" xs="12"><Link to="/admin/programs" style={{ textDecoration: 'none' }}><Card className="card-stats"><Card.Body><Row><Col xs="5"><div className="icon-big text-center"><i className="nc-icon nc-notes text-danger"></i></div></Col><Col xs="7"><div className="numbers"><p className="card-category">البرامج المتاحة</p><Card.Title as="h4">{loadingStats ? <Spinner size="sm" /> : stats.programs}</Card.Title></div></Col></Row></Card.Body><Card.Footer><hr /><div className="stats"><i className="fas fa-redo mr-1"></i>عرض التفاصيل</div></Card.Footer></Card></Link></Col>
          <Col lg="3" sm="6" xs="12"><Card className="card-stats"><Card.Body><Row><Col xs="5"><div className="icon-big text-center"><i className="nc-icon nc-paper-2 text-info"></i></div></Col><Col xs="7"><div className="numbers"><p className="card-category">شهادات معلقة</p><Card.Title as="h4">{loadingReports ? <Spinner size="sm" /> : pendingCertificates.length}</Card.Title></div></Col></Row></Card.Body><Card.Footer><hr /><div className="stats text-info"><i className="fas fa-info-circle mr-1"></i>انظر التقرير أدناه</div></Card.Footer></Card></Col>
        </Row>
        <Row>
          <Col lg="3" sm="6" xs="12"><Card className="card-stats"><Card.Body><Row><Col xs="5"><div className="icon-big text-center"><i className="nc-icon nc-single-02 text-primary"></i></div></Col><Col xs="7"><div className="numbers"><p className="card-category">طلاب بلا برنامج</p><Card.Title as="h4">{loadingReports ? <Spinner size="sm" /> : unassignedStudents.length}</Card.Title></div></Col></Row></Card.Body><Card.Footer><hr /><div className="stats text-primary"><i className="fas fa-info-circle mr-1"></i>انظر التقرير أدناه</div></Card.Footer></Card></Col>
          <Col lg="3" sm="6" xs="12"><Card className="card-stats"><Card.Body><Row><Col xs="5"><div className="icon-big text-center"><i className="fas fa-chalkboard-teacher text-danger"></i></div></Col><Col xs="7"><div className="numbers"><p className="card-category">فصول بلا مدرسين</p><Card.Title as="h4">{loadingReports ? <Spinner size="sm" /> : classroomsReport.length}</Card.Title></div></Col></Row></Card.Body><Card.Footer><hr /><div className="stats text-danger"><i className="fas fa-info-circle mr-1"></i>انظر التقرير أدناه</div></Card.Footer></Card></Col>
          <Col lg="3" sm="6" xs="12"><Card className="card-stats"><Card.Body><Row><Col xs="5"><div className="icon-big text-center"><i className="fas fa-school text-warning"></i></div></Col><Col xs="7"><div className="numbers"><p className="card-category">دورات بلا فصول</p><Card.Title as="h4">{loadingReports ? <Spinner size="sm" /> : coursesReport.length}</Card.Title></div></Col></Row></Card.Body><Card.Footer><hr /><div className="stats text-warning"><i className="fas fa-info-circle mr-1"></i>انظر التقرير أدناه</div></Card.Footer></Card></Col>
          <Col lg="3" sm="6" xs="12"><Card className="card-stats"><Card.Body><Row><Col xs="5"><div className="icon-big text-center"><i className="fas fa-user-tie text-secondary"></i></div></Col><Col xs="7"><div className="numbers"><p className="card-category">دورات بلا منسق</p><Card.Title as="h4">{loadingReports ? <Spinner size="sm" /> : coursesWithoutCoordinatorReport.length}</Card.Title></div></Col></Row></Card.Body><Card.Footer><hr /><div className="stats text-secondary"><i className="fas fa-info-circle mr-1"></i>انظر التقرير أدناه</div></Card.Footer></Card></Col>
        </Row>
