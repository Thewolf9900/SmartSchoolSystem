...
import { generateQuestionsFromText, generateQuestionsFromFile } from 'services/public/aiService';
...
function QuestionBankManagement() {
    ...
    const handleShowImage = (imageUrl) => { setImageToShow(`${process.env.REACT_APP_API_BASE_URL}/${imageUrl}`); setShowImageModal(true); };
