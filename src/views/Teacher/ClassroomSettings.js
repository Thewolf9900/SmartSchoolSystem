...
function ClassroomSettings() {
    ...
    const handleToggleStatus = async () => {
        try {
            const m = await toggleClassroomStatus(classroomId);
                        ...
                        <Row className="align-items-center">
                            ...
                            <Col>
                                <Breadcrumb className="bg-transparent p-0 mb-1" listProps={{ className: "bg-transparent p-0 m-0" }}>
                                    ...
                                    <Breadcrumb.Item active className="text-primary small">الإعدادات والإعلانات</Breadcrumb.Item>
                                </Breadcrumb>
                                <h3 className="mb-0 font-weight-bold ml-3" style={{ color: '#2c3e50' }}>الإعدادات والإعلانات</h3>
                            </Col>
                        </Row>
                    </Card.Body>
                </Card>
